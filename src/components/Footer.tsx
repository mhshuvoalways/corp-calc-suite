        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-white/70 mb-4">
              Your trusted partner in Spanish property investment. Expert guidance for Costa Blanca and Costa Calida properties.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/70">
              <li><a href="#" className="hover:text-secondary transition-colors">Properties</a></li>
              <li><a href="#" className="hover:text-secondary transition-colors">Calculator</a></li>
